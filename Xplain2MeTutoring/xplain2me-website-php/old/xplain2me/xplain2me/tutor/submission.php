                  ...
                  <ul class="art-menu">
                    ...
                    <li>
                      <a href="message.php"><span class="l"></span><span class="r"></span><span class="t">Messages</span></a>
                         ...
                         <li>
                      <a href="#" class="active"><span class="active"></span><span class="r"></span><span class="t">Submissions</span></a>
                    </li>
                    <li>
...
<form name="form1" method="post" action="update2.php">
  <table width="646" height="395" border="0">
    <tr>
      <td>How to submit: Fill in the following and click on submit</td>
    </tr>
    <tr>
      <td>Note: You are to submit only after completion of your lessons package and no payment may be done to you before you submit</td>
    </tr>
    ...
    <tr>
      <td>Number of lessons completed:</td>
      <td><label for="fName"></label>
        <input type="text" name="fName" id="fName" value="<?php echo"$name";?>"></td>  
    </tr>
    <tr>
      <td>Amount due to me:</td>
      <td><input type="text" name="address" id="address" value="<?php echo"$address";?>"></td> 
    </tr>   
    <tr>
      <td>Topics covered during all lessons:</td>
      <td><input type="text" name="address" id="address" value="<?php echo"$address";?>"></td> 
    </tr> 
    <tr>
      <td>Any absence or postponed lessons </td>
      <td><select name="absence" id="absence">
        <option value="No">No</option>
        <option value="Yes">Yes</option>
      </select></td>
    </tr>
    <tr>
      <td>If your answer to the above question is yes, state your reason(s):</td>
      <td><input type="text" name="Email" id="Email" value="<?php echo"$Email";?>" /></td>
    </tr>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
      <td><input name="Submit" type="submit" id="Submit" onClick="MM_validateForm('fName','','R','user_name','','R','user_pass','','R','Email','','RisEmail','contact','','RisNum');return document.MM_returnValue" value="Submit" class="art-button" ></td>
      <td>&nbsp;</td>
    </tr>
  </table>
  </form>

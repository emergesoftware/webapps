        ...
        <div class="art-sheet">
            ...
            <div class="art-sheet-body">
                ...
                <div class="art-nav">
                    ...
                    <li>
                      <a href="#"><span class="active"></span><span class="r"></span><span class="t">Progress Report</span></a>
                    </li>
                        <li>                 
                	</ul>
                </div>
...
<form name="form1" method="post" action="update2.php">
  <table width="646" height="395" border="0">
    ...
    <tr>
      <td>Topics covered in the previous three lessons:</td>
      <td><label for="fName"></label>
        <input type="text" name="fName" id="fName" value="<?php echo"$name";?>"></td>  
    </tr>
    <tr>
      <td>Short Description on learner&#39;s perfomance and problem areas on previous 3 lessons</td>
      <td><textarea style="width:250px; height:150px;"></textarea></td>
     <!-- <td><input type="text" name="address" id="address" value="<?php echo"$address";?>"></td> -->
    </tr>
    <tr>
      <td>Actions and approach taken on solving the learner&#39;s problem areas</td>
      <td><textarea style="width:250px; height:150px;"></textarea></td>
